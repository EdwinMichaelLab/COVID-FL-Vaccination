...
function [S_out,E_out,IA_out,IP_out,IM_out,IH_out,IC_out,D_out,R1_out,...
        ...
        E8_out,IA8_out,IP8_out,IM8_out,IH8_out,IC8_out,R10_out,D8_out] = SEIR_covid_model(ParamSets,NPop,...
...
%for i = 1:length(ParamSets(1,:))
    ...
    [t, pop] = ode45(@diff_eqn1,StartTime:1:MaxTime,...
        ...
        R60(i),D40(i),W0(i),W20(i),F0(i),VS0(i),...
        E50(i),IA50(i),IP50(i),IM50(i),IH50(i),IC50(i),R70(i),D50(i)...
